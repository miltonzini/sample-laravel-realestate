...
class ContactFormController extends Controller
{
    ...
    // TODO: developmentDetailsInfoSubmit()
    // TODO: Actualizar subject para property y development

    // TODO: Adaptar lo siguiente
    public function lotDetailsInfoSubmit(Request $request, $id)
    {
        ...
        try {
            ...
            $mail->addAddress('info@audacity.com.ar');
            $mail->isHTML(true);
            $mail->Subject = 'Consulta sobre un lote/emprendimiento';
            
            $mail->Body = view('emails.lotDetailsMessage', [
                'lotId' => $request->input('loty-id'),
